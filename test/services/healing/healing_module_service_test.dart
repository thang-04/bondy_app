...
void main() {
  ...
  test('adapts the current healing home payload for the full UI module', () async {
  ...
  test('translates legacy UI check-in input to the current server contract', () async {
    final client = await authenticatedClient(
      MockClient((request) async {
  ...
  test('loads entry state and active timeline for adaptive healing flow', () async {
    final client = await authenticatedClient(
      MockClient((request) async {
